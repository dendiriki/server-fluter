        ...
        case "get_location":
            ...
            case "insert_newonerow":
                ...
                try {
                    ...
                    $stmt = $conn->prepare("SELECT VC_PRODUCT_CODE FROM PROD_COIL_INVENTORY_SAP WHERE VC_BUNDLE_NO = :bundle");
                    ...
                    $des = $conn->prepare("SELECT MAKTG FROM MAKT WHERE MATNR = :description");
                ...
                case "insert_many_rows":
                    ...
                    try {
                        ...
                        $stmt = $conn->prepare("SELECT VC_PRODUCT_CODE, VC_BUNDLE_NO FROM PROD_COIL_INVENTORY_SAP WHERE VC_BUNDLE_NO BETWEEN :bundleFrom AND :bundleTo");
                        ...
                        foreach ($bundles as $bundle) {
                            ...
                            // Ambil deskripsi dari tabel MAKT
                            $des = $conn->prepare("SELECT MAKTG FROM MAKT WHERE MATNR = :matnr");
                            $des->bindParam(':matnr', $bundle['VC_PRODUCT_CODE'], PDO::PARAM_STR);
                            $des->execute();
                            $resdest = $des->fetch(PDO::FETCH_ASSOC);
                
                            // Kemudian, insert data ke ZPP_WR_SUBLOC_DETAILS
                            $insertStmt = $conn->prepare("INSERT INTO ZPP_WR_SUBLOC_DETAILS (MANDT, SRLNO, Z_WR_MATNR, Z_WR_MAKTX, Z_BUNDLE_NO, Z_M_SUBLOC, Z_SUBLOC, Z_USR, Z_DATE_TIME, Z_DATE, Z_TIME, Z_DEL_FLAG, Z_NOTE, Z_COLECT_ST) VALUES (600, :nilai, :matnr, :maktx, :bundle, :msubloc, :subloc, :usr, NOW(), CURDATE(), CURTIME(), 0, 'NO_REL', 'MANY ROWS')");
                            ...
                            $insertStmt->bindParam(':bundle', $bundle['VC_BUNDLE_NO'], PDO::PARAM_STR);
                    ...
                    try {
                        ...
                        foreach ($bundles as $bundle) {
                            ...
                            // Kemudian, insert data ke ZPP_WR_SUBLOC_DETAILS
                            $insertStmt = $conn->prepare("INSERT INTO ZPP_WR_SUBLOC_DETAILS (MANDT, SRLNO, Z_WR_MATNR, Z_WR_MAKTX, Z_BUNDLE_NO, Z_M_SUBLOC, Z_SUBLOC, Z_USR, Z_DATE_TIME, Z_DATE, Z_TIME, Z_DEL_FLAG, Z_NOTE, Z_COLECT_ST) VALUES (600, :nilai, :matnr, :maktx, :bundle, :msubloc, :subloc, :usr, NOW(), CURDATE(), CURTIME(), 0, 'NEW_REL', 'MANY ROWS')");
                            $insertStmt->bindParam(':nilai', $nilai);
                            $insertStmt->bindParam(':matnr', $bundle['VC_PRODUCT_CODE'], PDO::PARAM_STR);
                            $insertStmt->bindParam(':maktx', $resdest['MAKTG'], PDO::PARAM_STR);
                            $insertStmt->bindParam(':bundle', $bundle['VC_BUNDLE_NO'], PDO::PARAM_STR);
